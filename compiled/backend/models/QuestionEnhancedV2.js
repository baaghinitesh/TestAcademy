...
const OptionEnhancedSchema = new mongoose_1.Schema({
    text: {
        type: String,
...
const QuestionEnhancedSchema = new mongoose_1.Schema({
    question: {
        type: String,
...
QuestionEnhancedSchema.pre('save', function (next) {
...
QuestionEnhancedSchema.statics.findByHierarchy = function (classNumber, subjectId, chapter, topic) {
    const query = { classNumber, subject: subjectId, isActive: true };
    if (chapter)
...
QuestionEnhancedSchema.statics.findForAutoTest = function (classNumber, subjectId, difficulty, limit = 20) {
    const query = {
        classNumber,
        subject: subjectId,
        isActive: true,
...
QuestionEnhancedSchema.statics.getBulkUploadStats = function (batchId) {
...
exports.default = mongoose_1.default.models.QuestionEnhancedV2 || mongoose_1.default.model('QuestionEnhancedV2', QuestionEnhancedSchema);
