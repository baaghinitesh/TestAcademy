...
import { User, Subject, Test, QuestionEnhancedV2 } from '../backend/models';
      ...
      for (const [classNumber, tests] of Object.entries(classeData)) {
        ...
        for (const testData of tests) {
          ...
          for (let i = 0; i < testData.questions.length; i++) {
            ...
            const newQuestion = new QuestionEnhancedV2({
              test: newTest._id,
              question: questionData.question,
              questionType: (questionData as any).questionType || 'single-choice',
...
async function createMixedTests(subjectMap: Map<string, any>, adminUserId: any) {
